...
export const IconButton = () => (
  <div className='storybook__container button'>
    ...
    <Button icon='https://img.yzcdn.cn/rant/logo.png' type='primary'>
      Custom Icon Button
    </Button>
  </div>
);
...
export const ButtonURL = () => (
  <div className='storybook__container column button'>
    <Button tag='a' url='https://github.com/mxdi9i7/rant-react'>
      Button with URL
    </Button>
    <Button tag='a' replace url='https://github.com/mxdi9i7/rant-react'>
